...
legend('Interference free scenario, MMSE', 'Interference free scenario, ZF', ...
       'Perfect estimation, #0', 'Perfect estimation, #1', 'Perfect estimation, #2');
...
legend('L = 1,  F = 1', 'L = 1,  F = 1/7', 'L = 1, perfect channel estimation', ...
       'L = 7,  F = 1/7, # = 0', 'L = 7,  F = 1/7, # = 2', 'L = 7, perfect channel estimation', ...
